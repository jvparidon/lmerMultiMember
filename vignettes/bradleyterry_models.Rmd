...
# plot random effects
plot_model(m, 're', sort.est = TRUE, grid = FALSE,
...
So far, so good; the model correctly predicted the League's best and worst teams in the 2021 season. So what about our hypothetical matchup, the San Diego Chargers playing the Green Bay Packers?
