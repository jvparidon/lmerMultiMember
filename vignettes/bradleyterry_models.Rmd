...
```{stan, output.var = "bt_model_stan_code", eval = FALSE}
data {
...
# load a precompiled Stan model, to save time and resources
load('bt_model_stan.RData')
...
# sample from Stan model, with low number of samples to save time and resources
m_stan <- sampling(bt_model_stan, data = stan_data,
