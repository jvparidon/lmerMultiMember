---
title: "Group membership models using lmerMulitMember"
output: rmarkdown::html_vignette
author:
    - Ben Bolker, adapted by Phillip Alday
vignette: >
  %\VignetteIndexEntry{Group membership models using lmerMulitMember}
...
```{r}
# not yet sure why this fails without scoping
m1 <- lmerMultiMember::lmer(y ~ 1 + (1|membership), 
